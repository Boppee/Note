...
class PHPMailer
{
     ...
     * @var string
     */
    public $From = 'root@https://mrboppe.se';
     ...
     * Returns 'https://mrboppe.se.localdomain' if unknown.
     *
     * @return string
     */
    protected function serverHostname()
    {
        ...
        if (!static::isValidHost($result)) {
            return 'https://mrboppe.se.localdomain';
        }
